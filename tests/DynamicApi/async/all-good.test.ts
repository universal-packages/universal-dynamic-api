...
import ExcellentDynamic from '../../__fixtures__/async/all-good/Excellent.dynamic'
...
describe(DynamicApi, (): void => {
  it('Load dynamics and let call them', async (): Promise<void> => {
    const dynamicApi = new DynamicApi({ dynamicsLocation: './tests/__fixtures__/async/all-good' })

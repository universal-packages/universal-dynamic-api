...
import DefaultExcellentDynamic from '../__fixtures__/default-dynamic/DefaultExcellent.dynamic'
import DefaultGoodDynamic from '../__fixtures__/default-dynamic/DefaultGood.dynamic'
import ExcellentDynamic from '../__fixtures__/default-dynamic/Excellent.dynamic'
...
describe('DynamicApi', (): void => {
  it('perform dynamics by their default or by their first implementation even with default', async (): Promise<void> => {
    const dynamicApi = new DynamicApi({ dynamicsLocation: './tests/__fixtures__/default-dynamic' })
